...
<div>
    ...
    <x-form pageTitle='Products Create' action='create' enctype="multipart/form-data">
        ...
        <x-form-input-field.general col="col-3" lable="Sale Price" name="sale_price" type="text"
        ...
        <x-form-input-field.text-area col="" lable="Description" name="description" type="text"
        ...
        @endforeach
        <x-form-input-field.file col="col-6" label="Main Image" name="image" wireModel="image" :oldImage="$oldImage" />

        <x-form-input-field.file col="col-6" name="gallery" label="Gallery" wireModel="gallery" multiple="multiple"
